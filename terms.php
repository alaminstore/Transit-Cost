...
<div class="terms">
  <div class="container">
    ...
    <div class="conditions">
      ...
      <h5>In using this website you are deemed to have read and agreed to the following terms and conditions:</h5>
      <hr>
    ...
    <i class="fa fa-level-down" aria-hidden="true"></i><p class="gaps">excludes all liability for damages arising out of or in connection with your use of this website. This includes, without limitation, direct loss, loss of business or profits (whether or not the loss of such profits was foreseeable, arose in the normal course of things or you have advised this Company of the possibility of such potential loss), damage caused to your computer, computer software, systems and programs and the data thereon or any other direct or indirect, consequential and incidental damages</p>
  ...
  <p>No cancellation will be accepted. If cancel notification for instance, in person, via email, mobile phone ‘text message’ and/or fax, or any other means will be accepted subject to confirmation in writing. We reserve the right to levy non-refundable charge.</p>

  <h5>Termination of Agreements and Refunds Policy</h5>
  ...
  <p>Copyright and other relevant intellectual property rights exists on all text relating to the Company’s services and the full content of this website.</p> <br>
  ...
  <h5>Communication</h5>
  <p>We have several different e-mail addresses for different queries. These, & other contact information, can be found on our Contact Us link on our website or via Company literature or via the Company’s stated telephone, or mobile telephone numbers.</p>

  <p><span class="text-success">This company is registered United States, Reno, NV</span></p>
   ...
   <h6>These terms and conditions form part of the Agreement between the Client and ourselves. Your accessing of this website and/or undertaking of a booking or Agreement indicates your understanding, agreement to and acceptance, of the Disclaimer Notice and the full Terms and Conditions contained herein. Your statutory Consumer Rights are unaffected.</h6>
   ...
   <div class="cond text-center">
     <h5>Are you agree about all conditions? </h5>

       <a class="primary_btn" href="reg.php"><button type="button" class="btn btn-success">Agree</button></a>
       <a class="primary_btn" href="index.php"><button type="button" class="btn btn-danger">Decline</button><a class="primary_btn" href="terms.php">
   </div>
	</div>
  </div>
</div>
